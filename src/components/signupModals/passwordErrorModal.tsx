...
export default (props: any) => {
    let { setDisplayError } = props;
    return (
        <div className="flex justify-center py-5">
            <div className="bg-red-lightest border border-red-600 text-red-dark pl-4 pr-8 py-3 rounded absolute" role="alert">
                <strong className="font-bold text-red-600">IncorrectPassword!</strong>
                <span className="block sm:inline px-5 text-red-600">Password not matched</span>
